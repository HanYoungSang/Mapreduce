...
public class WordCount2 {
	...
	public static class MyMapper
			extends
				Mapper<LongWritable, Text, StringWritable, NumberWritable> {
	...
	public static class MyReducer
			extends
				Reducer<StringWritable, NumberWritable, StringWritable, NumberWritable> {

		private NumberWritable sumWritable = new NumberWritable();

		@Override
		protected void reduce(StringWritable key,
				Iterable<NumberWritable> values,
